...
job presentation, and resumable jobs (T7). #625 implements the server/router/job contract;
#626 remains the native Android proof for BiometricPrompt, Keystore, foreground service,
and device evidence. The complete package is a **release blocker** for the mobile full node
